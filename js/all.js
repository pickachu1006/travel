...
function getData(){
        ...
        xhr.onload=function(){   //readyState=4後觸發
            ...
            for(let i = 0;i<len;i++){
                if(a[i].Zone==str){
                detail.innerHTML+='<li><img class="top" src="'+a[i].Picture1+'"><div class="top-text"><div class="big">'+a[i].Name+'</div><div class="small">'+a[i].Zone+'</div></div></div><div class="bottom"><div class="icon"> <img src="img/clock.png" alt=""><span>'+a[i].Opentime+'</span></div><div class="icon"><img src="img/pin.png" alt=""><span>'+a[i].Add+'</span></div><div class="icon"><div class="phone"><img src="img/phone.png" alt=""><span>'+a[i].Tel+'</span></div><div class="tag"><img src="img/tag.png" alt=""><span>'+a[i].Ticketinfo+'</span></div></div></div></li>';
            } 
        }
    }
}
