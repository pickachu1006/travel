...
function getData() {
  ...
  xhr.onload = function () {
    ...
    for (var _i = 0; _i < len; _i++) {
      if (a[_i].Zone == str) {
        detail.innerHTML += '<li><img class="top" src="' + a[_i].Picture1 + '"><div class="top-text"><div class="big">' + a[_i].Name + '</div><div class="small">' + a[_i].Zone + '</div></div></div><div class="bottom"><div class="icon"> <img src="images/clock.png" alt=""><span>' + a[_i].Opentime + '</span></div><div class="icon"><img src="images/pin.png" alt=""><span>' + a[_i].Add + '</span></div><div class="icon"><div class="phone"><img src="images/phone.png" alt=""><span>' + a[_i].Tel + '</span></div><div class="tag"><img src="images/tag.png" alt=""><span>' + a[_i].Ticketinfo + '</span></div></div></div></li>';
      }
    }
  };
}
